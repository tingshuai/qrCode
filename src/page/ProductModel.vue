  ...
  <div class="gtoup-mange">
    <div class="my-tabs">
      <el-tabs type="border-card">
        <el-tab-pane label="基础设置 / 产品型号">
            <h1 class="title">产品型号</h1>
            <!-- 搜索 -->
            <mes-search :config="search.searchConfig" :data="search.searchData" @search="searchList"></mes-search>
            <!--  表格 -->
            <mes-table :tableConfig="tableConfig" :tableData="tableData" @sizeChange="sizeChange" @pageChange="pageChange" @add="add" @buttonFunction="buttonFunction" @remove="remove"></mes-table>
        </el-tab-pane>
      </el-tabs>
    </div>
    <!-- 添加 -->
...
<script>
 import {
    ...
    chatGroupsDelay, //修改
    retreatGroup, //删除
  } from "../api/ProductModel.js";
import toastBody from '../components/ProductModel/toastBody'
